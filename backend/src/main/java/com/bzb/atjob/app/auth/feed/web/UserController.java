...
import com.bzb.atjob.app.auth.core.user.application.UserApplicationService;
...
public class UserController extends BaseController {
  ...
  public ApiResult<List<com.bzb.atjob.app.auth.core.page.model.Page>> getPagesOwnedByUser(
